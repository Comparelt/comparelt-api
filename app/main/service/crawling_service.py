...
class CrawlingService:
    ...
    def crawl(search_input):
        ...
        # gets the second item from the product list because the first one is always an ad and may not be the product
        # searched
        ...
        CrawlingService.save_data(google_data)
        CrawlingService.save_data(coupang_data)
        CrawlingService.save_data(ssg_data)

        data = [google_data, coupang_data, ssg_data]
